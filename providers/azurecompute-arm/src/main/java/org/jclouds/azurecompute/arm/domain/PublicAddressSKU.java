...
public abstract class PublicAddressSKU {
   ...
   @Nullable
   public abstract PublicIPAddressSkuName name();

   @SerializedNames({"name"})
   public static PublicAddressSKU create(final PublicIPAddressSkuName name) {

      return new AutoValue_PublicAddressSKU(name);
   }
}
